...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-1064056.780480, 4716351.740394, -998568.694605, 4757259.743650], maxZoom: 28, minZoom: 1
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([-1064056.780480, 4716351.740394, -998568.694605, 4757259.743650], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Transferências de Uso do Solo – COS 2018 → COS 2023 (Torres Vedras)</h2>';
        return titleElement;
    })(),
